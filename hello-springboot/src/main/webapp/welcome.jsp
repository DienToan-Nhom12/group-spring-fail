...
</title><link href="resource/css/show_img.css" rel="stylesheet" type="text/css">
...
<link rel="shortcut icon" type="image/png" href="resource/img/logo.png"><link href="resource/css/lightbox1.css" rel="stylesheet" type="text/css">
...
<link href="resource/axd/WebResource.axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="resource/axd/WebResource(1).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><link href="resource/axd/WebResource(2).axd" type="text/css" rel="stylesheet" class="Telerik_stylesheet"><script type="text/javascript" src="chrome-extension://aadgmnobpdmgmigaicncghmmoeflnamj/ng-inspector.js"></script></head>
...
<script src="resource/js/jsdebug" type="text/javascript"></script>
<script src="resource/js/jsdebug(1)" type="text/javascript"></script>
<script src="resource/js/jsdebug(2)" type="text/javascript"></script>
<script src="resource/js/jsdebug(3)" type="text/javascript"></script>
<div>
...
<div class="thongbao_phong">
    <div class="topictb_phong_blue">
        ...
        <a class="wobble-horizontal" href="http://icsse2017.hcmute.edu.vn/?TopicId=31ca0f13-71be-4bd9-ad28-d3589a3cf6d2">
            <img src="resource/img/arrow_all_phong.png"></a>
    </div>
